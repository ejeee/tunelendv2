...
const Footer = () => {
  return (
    <>
      <div className="w-full h-auto px-48 bg-[#165668] py-12 text-white">
        <img src={tunelendLogo} className="w-18 h-auto" alt="" />
        ...
        <div className="flex">
          <img src={kampusMerdeka} alt="" className="w-22 h-fit" />
          <img src={infinite} alt="" className="w-24 h-fit" />
        </div>
        <hr className="mt-6" />
